...
`--lane small` is simple-serving's rehearsal: the cheapest card of 16 GB or more, Ampere or newer, under $0.25 an hour
with 60 GB of disk, for Gemma 4 E2B on vLLM. It prints the card's name as `gpu`.
