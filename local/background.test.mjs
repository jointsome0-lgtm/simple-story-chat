...
import { createBackgroundClient, serveBackground } from './background.mjs';

const turn = () => new Promise(resolve => setImmediate(resolve));
const request = { system: 'Synthetic', messages: [{ role: 'user', content: 'Synthetic' }], maxOutputTokens: 256 };
