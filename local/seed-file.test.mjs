...
import { createSeedFileReader, SEED_BYTES } from './seed-file.mjs';
...
function fixture(options = {}) {
  ...
  const run = (overrides = {}) => read({ file_name: 'seed.md', file_id: 'synthetic-id', ...overrides });
