...
// which the sheet lacked (docs/illustrations-plan.md#portrait-details); and the same words, with the skin tone, in the
// look the frame writes of a person the sheet does not name, the same day, where the rule allowed an adult's words only.
